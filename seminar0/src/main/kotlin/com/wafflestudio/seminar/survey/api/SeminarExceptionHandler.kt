...
import com.wafflestudio.seminar.exception.NoSuchNameException
...
class SeminarExceptionHandler {
    ...
    @ExceptionHandler(value = [NoSuchNameException::class])
    fun handle(e: NoSuchNameException): ResponseEntity<Any> {
